...
# Sounds (Experiment)
# ---------------------------
SOUNDS_DIR = "/Users/sunt/PhD/packngo/sounds/" 
...
results_dir = "/Users/sunt/PhD/packngo/results"
...
# ---------------------------
INSTRUCTIONS_DIR = "/Users/sunt/PhD/packngo/Instructions/"
...
def run_trial(is_training, target_sound, trial_info, display_on_border=False):
    ...
    while not trial_done:
        ...
        if phase == "exploration":
            ...
            font = pygame.font.SysFont("Arial", 20)
            instruction_text = font.render("Press Enter when you think you know the location of the target", True, WHITE)
            # Position text at bottom of screen, centered horizontally
            text_rect = instruction_text.get_rect(centerx=WIN_WIDTH//3, bottom=WIN_HEIGHT-30)
