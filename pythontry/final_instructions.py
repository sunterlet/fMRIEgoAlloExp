...
def run_trial(is_training, target_sound, trial_info, display_on_border=False):
    ...
    while not trial_done:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN:
                    if phase == "exploration":
                        ...
                        trial_done = True
                # For movement indicator: record arrow key press if not already active.
                if phase == "exploration":
        ...
        if phase == "exploration":
            ...
            if is_training:
                # Training block: show arena border and avatar.
                draw_arena()
                draw_player_avatar(player_pos, player_angle)
                if keys[pygame.K_k]:
                    for pos in current_target_positions:
                ...
                # Dark training and test blocks
                if not started_moving:
                    # Before any arrow key press, show the avatar at center
