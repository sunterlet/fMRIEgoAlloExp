...
def load_fixation_images():
    """Load fixation cross images from the parent directory."""
    # Get the parent directory (where the fixation images are stored)
    parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    
    # Define image paths
    black_on_white_path = os.path.join(parent_dir, "fixation_cross_black_on_white.png")
    white_on_black_path = os.path.join(parent_dir, "fixation_cross_white_on_black.png")
