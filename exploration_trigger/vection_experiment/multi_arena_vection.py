...
def load_arena_data():
    ...
    # Load from Final111_New_Arenas.csv (in exploration_trigger parent dir)
    arena_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "Final111_New_Arenas.csv")
