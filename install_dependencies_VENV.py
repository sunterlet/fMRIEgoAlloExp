#!/usr/bin/env python3
"""
Install Dependencies for fMRI Navigation Experiments
This script installs all required Python packages for the fMRI experiments.
Designed to work within a virtual environment.
"""
...
def check_virtual_environment():
    ...
    if hasattr(sys, 'real_prefix') or (hasattr(sys, 'base_prefix') and sys.base_prefix != sys.prefix):
        ...
        print("   This is okay, but using a virtual environment is recommended")
        return False
